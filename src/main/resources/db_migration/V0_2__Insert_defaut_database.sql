...
insert into play_against (datetime, stadium, team_1_id, team_2_id) values ('2022/09/08', 'LSLS Stadium', 1, 3);
insert into play_against (datetime, stadium, team_1_id, team_2_id) values ('2022/04/20', 'Frankfurt Stadium', 1, 2);
insert into play_against (datetime, stadium, team_1_id, team_2_id) values ('2022/11/14', 'Iran Park', 2, 1);
insert into play_against (datetime, stadium, team_1_id, team_2_id) values ('2022/08/14', 'Switzerland park', 2, 4);
insert into play_against (datetime, stadium, team_1_id, team_2_id) values ('2022/09/18', 'Mumbai Stadium', 1, 3);
